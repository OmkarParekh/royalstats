          ...
          <div className="col-12">
            <div className="container-header d-flex">
              <div className="headertitle">
                <img src={people} alt="Cards-icon" className="header-icon" />
                <span className="title-name">Members</span>
              </div>

              <div class="dropdown cardCategory">
                <span
                  class="dropdown-toggle category-text"
                ...
                <div class="dropdown-menu ml-1">
                  <span
                    class="dropdown-item option-item text-center btn"
                    onClick={() =>
                      this.setState({ activeOption: "All Player" })
                    }
                  >
                    All Player
                  </span>
                  <span
                    ...
                    onClick={() =>
                      this.setState({ activeOption: "By Donations" })
                    }
                  >
                    By Donations
                  </span>
              ...
              <table className="table table-hover table-borderless table-responsive-sm">
                <thead>
                  <tr>
                    ...
                    <th scope="col" className="text-wrap hide text-center">
                      Donations Received
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {this.state.activeOption === "All Player" &&
                    Object.values(obj).map(MemberItem => {
                      return <MemberTable member={MemberItem} />;
                    })}

                  {
                  this.state.activeOption === "By Donations" &&  
                    arraysort(Object.values(obj), ['donations'], {reverse: true}).map(MemberItem => {
                      return <MemberTable member={MemberItem} />;
                    })
                  }
                </tbody>
